...
### Fixed
- Enable backward capture for International draughts variant
- Resolved missing translations in Flatpak

### Documentation
- Added comprehensive TODO list
- Added code analysis report

## [2.0.3] - 2025-10-21

### Added
- Russian translation (contributed by Vladislav https://github.com/ma12vlad)

### Changed
- Updated translator credits in About dialog to include Vladislav

## [2.0.2] - 2025-10-21

### Changed
- Removed .specify/ directory with project specification tools
...
### Added
- **High-Resolution SVG Icon**: Updated application icon to modern SVG format with improved visual quality
- **Statistics Dashboard**: Server-side `/stats` endpoint providing real-time multiplayer statistics
- **Resignation Tracking**: Complete tracking of game resignations with proper win counter updates
- **Confirmation Dialogs**: Added resignation confirmations for critical actions:
  - New Game (Ctrl+N)
  - Play Online (Ctrl+M)
  - Reset Game (Ctrl+R)
  - Quit/Close Window (Ctrl+Q or X button)

### Fixed
- **Duplicate Game End Dialogs**: Multiplayer games now properly skip local game-over checks
- **Board State Synchronization**: Board adapter correctly updates `current_game` reference when state changes during reconnection
- **Server Connection Stability**: Enhanced reconnection handling and session persistence

### Changed
- **PDN File Extensions**: Changed game export format from `.pgn` to `.pdn` for proper Portable Draughts Notation compliance
- **Multiplayer UI**: Removed disconnect button, keeping only resign button for cleaner interface
- **Server Infrastructure**: Updated server domain configuration and added Supabase integration support

### Improved
- Enhanced GitHub workflow configuration for Flathub repository
- Better error handling during multiplayer sessions
...
- Node.js multiplayer server infrastructure
- Session management and persistence
- Enhanced network error handling
- Multiplayer connection state management
...
**Full Changelog**: https://github.com/tobagin/Draughts/releases
